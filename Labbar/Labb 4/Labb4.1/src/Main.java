...
//        System.out.println(graph.toString());
        ...
        while(true) {
            ...
            DepthFirstPaths dfs = new DepthFirstPaths(graph, symbolGraph.indexOf(sourceVertex));

            if (dfs.hasPathTo(symbolGraph.indexOf(targetVertex))) {
                System.out.println("There is a path from the source vertex: " + sourceVertex + " to the target vertex: " + targetVertex);

                for (int x : dfs.pathTo(symbolGraph.indexOf(targetVertex))) {
